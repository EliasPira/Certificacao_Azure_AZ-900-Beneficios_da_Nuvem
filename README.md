...
- **Modelos de Preço**: Baseado em consumo (pay-as-you-go).
- **CapEx vs OpEx**: Diferença entre despesas de capital e operacionais.
- **Responsabilidade Compartilhada**: Divisão de tarefas entre cliente e provedor.
...
- [Portal Azure](https://azure.microsoft.com/pt-br/free)
...
- Identificar os modelos de implantação e suas aplicações.
- Compreender os modelos de precificação e consumo.
- Reconhecer os pilares de segurança, governança e gerenciamento na nuvem.

---

## 📌 Referência

Material baseado curso da DIO sobre certificação AZ-900.
